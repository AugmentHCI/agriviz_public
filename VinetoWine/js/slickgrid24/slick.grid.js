...
(function($) {
    ...
    function SlickGrid(container, data, columns, options) {
        ...
        var defaults = {
            ...
            asyncPostRenderCleanupDelay: 400,
            autoHeight: false,
        ...
        function init() {
            ...
            $headerRowSpacerL.width("width", getCanvasWidth() + scrollbarDimensions.width + "px");
            $headerRowSpacerR.width("width", getCanvasWidth() + scrollbarDimensions.width + "px");
        ...
        function autosizeColumns(autosizeMode, isInit) {
            ...
            var i, c, colWidth, reRender, totalWidth = 0,
                totalWidthLessSTR = 0,
                strColsMinWidth = 0,
                totalMinWidth = 0,
        ...
        function getColWidth(columnDef, $gridCanvas, data) {
            ...
            var len, max = 0,
                text, maxText, formatterResult, maxWidth = 0,
                val;
            ...
            while (total < availWidth) {
                ...
                for (i = 0; i < columns.length && total < availWidth; i++) {
                    ...
                    if (!c.resizable || c.maxWidth <= currentWidth) {
                        ...
                        growSize = Math.min(Math.floor(growProportion * currentWidth) - currentWidth, (c.maxWidth - currentWidth) || 10000000) || 1;
                    }
                    total += growSize;
